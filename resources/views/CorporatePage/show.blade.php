    ...
    <div class="page-content">
        <div class="container">
            <div class="page-tree">
                ...
                {{ Breadcrumbs::render('kurumsal.show',$corporatePage) }}

            </div>

            <div class="kurumsal-text pb-3">
                <h1>{{ $corporatePage->title }}</h1> 
            </div>
            ...
            <div class="logos-section">
                <div class="row">
                    ...
                    @if( $corporatePage->insurance_Companies )

                        @foreach ($corporatePage->insurance_Companies as $insuranceCompany)
