...
@section('content')
    <div class="page-content">
        <form action="{{route('refreshRouteCache')}}" method="post" style="display: flex; justify-content: end; padding: 0 10px;">
            @csrf
                <button type="submit" class="btn btn-danger"><span class="icon voyager-forward"></span> refresh Route Cache</button>
        </form>
