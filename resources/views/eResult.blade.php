...
@push('js')
    <script>
        var strScriptSrc = "//onlinerandevu.maltepehastanesi.com.tr/widget?tek=0&hid=MaltepeUni&hadi=Maltepe Hastanesi&randevu=0&altbtn=0&customcontainerid=pusula-container";
